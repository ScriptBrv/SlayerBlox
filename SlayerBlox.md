                                ...
                                {            
                                    ...
                                    ["fields"]= {
                                        ...
                                        },
                                        {
                                            ...
                                            ["value"]= "```Người dùng đã chạy Slayer hub  Hub Auto Farm Cảm Ơn Vì Đã Dùng RinX!!!!```",
                                            ["inline"]= true
                                            },
                                       {
                                     ["name"] = "𝙅𝙤𝙗 𝙄𝙙",
...
setclipboard("Slayer hub Is The Best")
...
Tabs.Main:AddButton({
        Title = "Slayer hub Discord Server",
...
Fluent:Notify({
    Title = "Slayer hub",
    Content = "Thanks For Using Slayer hub",
    Duration = 8
})
